...
// ID_CARTE 0x1 => Définit dans communication.h
...
int main (void)
{
	...
	PLLFBD=41;			// M=43 <=> PLLFBD = 41 <=> 40MHz | M=32 <=> PLLFBD = 30 <=> 30MHz
	...
	T2Initialize(0.05, Carte.Fcy); // Periode de l'envoi automatique des mesures
